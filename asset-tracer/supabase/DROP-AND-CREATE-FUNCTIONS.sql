...
-- =====================================================
-- Run this instead of functions.sql when you need to update function signatures
-- =====================================================
...
-- Drop all functions (safe - won't error if they don't exist)
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Creating functions with correct types...';
END $$;
...
-- =====================================================
-- Function 3: Get Financial Summary
-- =====================================================
...
-- =====================================================
-- Function 4: Get Asset ROI Rankings
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '  1. get_asset_financials(org_id)';
    RAISE NOTICE '  2. get_monthly_pl(org_id, start_date, end_date)';
    RAISE NOTICE '  3. get_financial_summary(org_id)';
    RAISE NOTICE '  4. get_asset_roi_rankings(org_id, limit)';
    RAISE NOTICE '';
    RAISE NOTICE '👉 Test with: SELECT * FROM get_financial_summary(''your-org-uuid'');';
    RAISE NOTICE '';
END $$;
